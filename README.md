...
5. Go to infra/modules/eks/4-kubeconfig.tf. In line 26, change to your own configured IAM role (for access to kubernetes though kubectl).
6. Push changes to your remote repo, the pipeline will be triggered on push and it would deploy the infrastructure on AWS.
